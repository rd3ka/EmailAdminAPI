package xyz.YA.Employee;

import java.sql.Statement;
import java.sql.Date;
import java.sql.PreparedStatement;

import xyz.YA.Database.*;
...
public class EmployeeDAO {
  ...
  final public static void createEmployeeDatabase(Database database) {
    try {
      ...
      /*
       * ^statement executes the query to create the actual database
       * the final database name is set to, YetAnotherDatabase
       */
  ...
  final public static void createEmployeeTable(Database employeeDatabase) {
    try {
       ...
       * will be stored
       * the final table name is set to, employee
       */
  ...
  final public static void insertEmployee(Employee e, Database employeeDatabase) {
    try {
       ...
       * placeholders
       * in the query in order to have a complete valid query
       **/
      prep_state.execute();
      /*
